...
wget http://www.222.run/01/mt7621_zte_e8820s.dts

wget http://www.222.run/01/mt7621.mk

wget http://www.222.run/01/01_leds

wget http://www.222.run/01/platform.sh

wget http://www.222.run/01/image.mk
